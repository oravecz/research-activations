...
Event 95: Nordstrom - Bode at The Corner - Flagship Pop-Up Series
Need 8 more images
═══════════════════════════════════════════════════════════════════════════════
...
1. "Nordstrom Bode at The Corner - Flagship Pop-Up Series activation photos"
2. "Nordstrom Bode at The Corner - Flagship Pop-Up Series event images March 14 - April 7, 2024"

SECONDARY (Look for event coverage on news/trade sites):
1. site:retailtouchpoints.com "Nordstrom Bode at The Corner - Flagship Pop-Up Series"
2. site:parasolprojects.com "Nordstrom Bode at The Corner - Flagship Pop-Up Series"
3. "Nordstrom pop-up" event 2024 photographer

TERTIARY (Broader brand activation searches):
1. "Nordstrom store activation March 14 "
2. "Nordstrom retail marketing event"
3. "Nordstrom in-store experience"
...
3. Save to: public/events/nordstrom/event-95/images/
4. Name as: image-[N].png or image-[N].webp (where N is next available number)
5. Target: 8 images (total 9 with logo)
...
const filePath = 'public/events/nordstrom/event-95/images/image-1.png';
...
1. Verify all images saved to: public/events/nordstrom/event-95/images/
2. Update details.json imageInventory for this event
