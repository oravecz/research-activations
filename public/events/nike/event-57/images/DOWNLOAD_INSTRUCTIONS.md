...
Event 57: Nike - Urban Outfitters Nike On Rotation Experience
Need 3 more images
═══════════════════════════════════════════════════════════════════════════════
...
PRIMARY (Most specific - TRY FIRST):
  1. "Nike Urban Outfitters Nike On Rotation Experience activation photos"
  2. "Nike Urban Outfitters Nike On Rotation Experience event images May 2024"

SECONDARY (Look for event coverage on news/trade sites):
  1. site:retailtouchpoints.com "Nike Urban Outfitters Nike On Rotation Experience"
  2. site:parasolprojects.com "Nike Urban Outfitters Nike On Rotation Experience"
  3. "Nike pop-up" event 2024 photographer

TERTIARY (Broader brand activation searches):
  1. "Nike store activation May 2024"
  2. "Nike retail marketing event"
  3. "Nike in-store experience"
...
3. Save to: public/events/nike/event-57/images/
4. Name as: image-[N].png or image-[N].webp (where N is next available number)
5. Target: 3 images (total 9 with logo)
...
EXAMPLE NODE SCRIPT:
  ...
  const filePath = 'public/events/nike/event-57/images/image-1.png';
...
1. Verify all images saved to: public/events/nike/event-57/images/
