...
PRIMARY (Most specific - TRY FIRST):
  1. "Nike Nike Running @ The Corner - Nordstrom NYC Pop-Up activation photos"
  2. "Nike Nike Running @ The Corner - Nordstrom NYC Pop-Up event images August 7 - September 2, 2025"

SECONDARY (Look for event coverage on news/trade sites):
  1. site:retailtouchpoints.com "Nike Nike Running @ The Corner - Nordstrom NYC Pop-Up"
  2. site:parasolprojects.com "Nike Nike Running @ The Corner - Nordstrom NYC Pop-Up"
  3. "Nike pop-up" event 2024 photographer

TERTIARY (Broader brand activation searches):
  1. "Nike store activation August 7 "
...
3. Save to: public/events/nike/event-90/images/
...
EXAMPLE NODE SCRIPT:
  ...
  const filePath = 'public/events/nike/event-90/images/image-1.png';
...
1. Verify all images saved to: public/events/nike/event-90/images/
