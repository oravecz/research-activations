...
PRIMARY (Most specific - TRY FIRST):
  1. "Adidas BAPE x Adidas Forum 84 Legends Arcade activation photos"
  2. "Adidas BAPE x Adidas Forum 84 Legends Arcade event images 2023"

SECONDARY (Look for event coverage on news/trade sites):
  1. site:retailtouchpoints.com "Adidas BAPE x Adidas Forum 84 Legends Arcade"
  2. site:parasolprojects.com "Adidas BAPE x Adidas Forum 84 Legends Arcade"
  3. "Adidas pop-up" event 2024 photographer

TERTIARY (Broader brand activation searches):
  1. "Adidas store activation 2023"
  2. "Adidas retail marketing event"
  3. "Adidas in-store experience"
...
3. Save to: public/events/adidas/event-92/images/
...
EXAMPLE NODE SCRIPT:
  ...
  const filePath = 'public/events/adidas/event-92/images/image-1.png';
...
1. Verify all images saved to: public/events/adidas/event-92/images/
