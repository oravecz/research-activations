...
PRIMARY (Most specific - TRY FIRST):
  1. "Target Diane von Furstenberg Pop-Up at The Shed activation photos"
  2. "Target Diane von Furstenberg Pop-Up at The Shed event images March 15-16, 2024"

SECONDARY (Look for event coverage on news/trade sites):
  1. site:retailtouchpoints.com "Target Diane von Furstenberg Pop-Up at The Shed"
  2. site:parasolprojects.com "Target Diane von Furstenberg Pop-Up at The Shed"
  3. "Target pop-up" event 2024 photographer

TERTIARY (Broader brand activation searches):
  1. "Target store activation March 15"
...
3. Save to: public/events/target/event-91/images/
...
EXAMPLE NODE SCRIPT:
  ...
  const filePath = 'public/events/target/event-91/images/image-1.png';
...
1. Verify all images saved to: public/events/target/event-91/images/
