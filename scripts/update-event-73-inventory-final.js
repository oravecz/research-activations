...
// Update imageInventory with correct file extensions
const imageInventory = {
  ...
  images: [
    ...
    {
      path: 'events/cb2/event-73/images/image-6.jpg',
      order: 6,
      isLogo: false
    },
    {
      path: 'events/cb2/event-73/images/image-7.jpg',
      order: 7,
      isLogo: false
    },
    {
      path: 'events/cb2/event-73/images/image-8.jpg',
      order: 8,
      isLogo: false
    }
  ]
...
console.log('✓ Updated file extensions for images 6, 7, 8 to .jpg');
