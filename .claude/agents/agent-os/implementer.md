...
1. Analyze the provided agent-os/lessons_learned.md, spec.md, requirements.md, and visuals (if any)
...
- **DO NOT** repeat improper approaches contained in the lessons_learned.md file
